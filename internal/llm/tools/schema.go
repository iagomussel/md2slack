			...
			Function: &llms.FunctionDefinition{
				...
				Parameters: map[string]interface{}{
					...
					"properties": map[string]interface{}{
						...
						"details":         map[string]interface{}{"type": "string", "description": "Detailed details"},
			...
			Function: &llms.FunctionDefinition{
				...
				Parameters: map[string]interface{}{
					...
					"properties": map[string]interface{}{
						...
						"details": map[string]interface{}{"type": "string", "description": "Technical details/summary to add"},
					},
					"required": []string{"index", "details"},
				},
			},
		},
		{
