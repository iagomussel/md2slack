							...
							>
								{#each ACTIONS as action}
									<button
										...
										class="w-full flex items-center gap-3 px-4 py-2.5 text-xs text-gray-300 hover:bg-white/5 transition-colors text-left {action.destructive ? 'hover:text-red-400' : 'hover:text-orange-400'}"
									>
										<svg
